...
copy_safe "$BOOT/rules/frontend-standards.mdc" "$TARGET/.cursor/rules/frontend-standards.mdc"
...
link_claude_md "$TARGET" commands/frontend "commands/frontend"
...
echo "               /frontend:analyze-patterns, ...); Cursor: /frontend-discover, ..."
